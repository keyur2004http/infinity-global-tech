...
export default function AboutUsSection() {
  ...
  return (
    ...
    >
      ...
      />
      <motion.div
        className="absolute top-1/2 left-1/4 w-4 h-4 rounded-full bg-[#304068]/30"
        animate={{
          y: [0, -15, 0],
          opacity: [0.5, 1, 0.5],
        }}
      ...
      >
        ...
        <motion.p className="text-center max-w-2xl mx-auto mb-16 text-[#202e44]/80" variants={itemVariants}>
          We are a passionate team of digital marketers and developers dedicated to crafting impactful online presences
          that drive growth and connect with your audience. With attention to detail and commitment to excellence, we
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          ...
          <div className="flex justify-center items-center order-first md:order-none mb-8 md:mb-0">
            <motion.div className="relative w-full max-w-xs" variants={itemVariants}>
              ...
              <motion.div
                className="absolute -top-4 -right-8 w-16 h-16 rounded-full bg-[#304068]/10"
              ...
              <motion.div
                className="absolute -top-10 left-1/2 -translate-x-1/2 w-3 h-3 rounded-full bg-[#304068]"
                animate={{
                  y: [0, -10, 0],
                  opacity: [0.5, 1, 0.5],
                }}
        ...
        >
          <div className="flex-1">
            ...
            <p className="text-white/80">Let's grow together.</p>
          </div>
          <Link href="/contact">
          <motion.button
            className="bg-[#304068] hover:bg-[#304068]/90 text-white px-6 py-3 rounded-lg flex items-center gap-2 font-medium transition-colors"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          >
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h3 className="text-xl font-medium text-[#202e44] group-hover:text-[#304068] transition-colors duration-300">
          {title}
        </h3>
      </motion.div>
      <motion.p
      ...
      <motion.div
        className="mt-3 pl-12 flex items-center text-[#304068] text-xs font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300"
        initial={{ opacity: 0 }}
        animate={{ opacity: 0 }}
      >
...
function StatCounter({ icon, value, label, suffix, delay }: StatCounterProps) {
  ...
  return (
    ...
    >
      ...
      <motion.div className="w-10 h-0.5 bg-[#304068] mt-3 group-hover:w-16 transition-all duration-300" />
    </motion.div>
